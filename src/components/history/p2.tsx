  ...
  const researches = [
    {
      ...
      year: "2016",
      description: "انواع شیرهای فشارشکن با مکانیزم‌های داخلی قسمت متحرک مورد بررسی قرار دادند. به این نتیجه رسیدند که طراحی و انتخاب نوع مکانیزم داخلی نقش مهمی در کارایی و کنترل فشار این شیرها دارد.",
      category: "پیشینه کلی"
    },
    {
      id: 2,
      ...
      year: "2022",
      description: "عملکرد شیرهای فشارشکن مستقیم، پایلوت‌دار و الکترونیکی در شرایط ناپایدار مورد مقایسه قرار دادند. نتایج نشان داد که شیرهای الکترونیکی در این شرایط عملکرد مطلوب‌تری دارند، در حالی‌که شیرهای پایلوت‌دار با تأخیر در پاسخگویی مواجه‌اند و شیرهای مستقیم نیز کمترین دقت را از خود نشان دادند. ",
      category: "پیشینه کلی"
    },
    {
      id: 3,
      ...
      year: "2019",
      description: "به برسی شیر های فشار شکن در ساختمان های بلند پرداختند و استفاده از شیر های فشار شکن برای ساختمان های بالای ۱۵-۲۰ طبقه را ضروری عنوان کردند.",
