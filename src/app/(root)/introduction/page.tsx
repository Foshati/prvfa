        ...
        <div className="space-y-8">
          ...
          <section className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed text-justify">
              <p className="mb-4">
                با افزایش جمعیت، توسعه شهرنشینی و گسترش فعالیت های کشاورزی و صنعتی، نیاز به خطوط انتقال و توزیع پایدار و کارآمد بیش از گذشته احساس می شود. یکی از مهم ترین چالش ها  در سیستم های انتقال و توزیع آب، مدیریت صحیح فشار در خطوط لوله است که فشار نامتعادل در خطوط لوله می تواند پیامدهایی مانند ترکیدگی لوله ها، نشت آب، افزایش تلفات انرژی در شبکه و کاهش عمر مفید زیرساخت ها را به همراه داشته باشد.
              </p>
